...
/**
 * Browser-side implementation of the Greenways Supersonic provider contract.
...
export function normalizeGraph(input) {
  ...
  return { [GRAPH_ID]: id, title: text(value.title) || id, nodes, connections };
}
...
export function normalizeControlValue(control, value) {

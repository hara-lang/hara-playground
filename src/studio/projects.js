export const FEATURED_PROJECTS = Object.freeze([
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/supersonic-live" }),
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/live-values" }),
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/interface-composition" }),
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/hodos-document" }),
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/hodos-graph" }),
    sourceUrl: "https://github.com/hara-lang/hara-playground/tree/main/samples/hodos-graph",
    entry: "src/main.hal",
  ...
  Object.freeze({
    ...
    repository: Object.freeze({ owner: "hara-lang", repo: "hara-playground", branch: "main", path: "samples/decision-model" }),
